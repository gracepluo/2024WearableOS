...
class HeartRateService : Service(), SensorEventListener {
    ...
    private fun sendHeartRate(heartrate: Int) {
        ...
        //val keyBytes = mykey.encoded()
        //val encodedKey = Base64.getEncoder().encodeToString(mykey.getEncoded())
        //Log.d("key string: ", mykey.toString())
        ...
        val httpRequest = object : StringRequest(
            ...
            override fun getBody(): ByteArray {
                ...
                //val localPDataT = "rate=".toByteArray(Charsets.UTF_8)+heartrate_enc

                val localPData = "rate=${heartrate_enc}"+"&patient=${patient_id}"
                Log.d(" String from Byte Array: ", localPData.toString())
